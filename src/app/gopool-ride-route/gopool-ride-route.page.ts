...
@Component({
  selector: 'app-gopool-ride-route',
  templateUrl: './gopool-ride-route.page.html',
  styleUrls: ['./gopool-ride-route.page.scss'],
})
export class GopoolRideRoutePage implements OnInit {
  viewType: string;
  counter = 0;
  ...
  rate_ride_taker() {
    this.route.navigate(['./gopool-rate-ride-taker']);
  }
