...
@Component({
  selector: 'app-handyzone-work-ratings',
  templateUrl: './handyzone-work-ratings.page.html',
  styleUrls: ['./handyzone-work-ratings.page.scss'],
})
export class HandyzoneWorkRatingsPage implements OnInit {
  viewType: string;
  counter = 0;
