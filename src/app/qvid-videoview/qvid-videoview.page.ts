...
import { QvidCommentPage } from '../qvid-comment/qvid-comment.page'; 
import { Video } from 'src/models/video.models';


@Component({
  selector: 'app-qvid-videoview',
  templateUrl: './qvid-videoview.page.html',
  styleUrls: ['./qvid-videoview.page.scss'],
})
export class QvidVideoviewPage implements OnInit {
  ...
  constructor(private route: Router, private modalController: ModalController) {
    let vids = [new Video("assets/images/Qvid/video/vid1.mp4"), new Video("assets/images/Qvid/video/vid2.mp4"), new Video("assets/images/Qvid/video/vid3.mp4"), new Video("assets/images/Qvid/video/vid4.mp4")];
  ...
  // }
  comment() {
    this.modalController.create({ component: QvidCommentPage }).then((modalElement) => {
