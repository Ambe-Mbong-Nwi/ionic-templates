...
@Component({
  selector: 'app-gopool-rate-ride-taker',
  templateUrl: './gopool-rate-ride-taker.page.html',
  styleUrls: ['./gopool-rate-ride-taker.page.scss'],
})
export class GopoolRateRideTakerPage implements OnInit {
  ratingIcon1 = false;
  ratingIcon2 = false;
  ratingIcon3 = false;
  ratingIcon4 = false;
