...
@Component({
  selector: 'app-gopool-pool-taker-info',
  templateUrl: './gopool-pool-taker-info.page.html',
  styleUrls: ['./gopool-pool-taker-info.page.scss'],
})
export class GopoolPoolTakerInfoPage implements OnInit {
  viewType: string;
  counter = 0;
