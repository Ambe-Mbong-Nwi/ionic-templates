...
@Component({
  selector: 'app-gopool-pool-info',
  templateUrl: './gopool-pool-info.page.html',
  styleUrls: ['./gopool-pool-info.page.scss'],
})
export class GopoolPoolInfoPage implements OnInit {
  viewType: string;
  counter = 0;
