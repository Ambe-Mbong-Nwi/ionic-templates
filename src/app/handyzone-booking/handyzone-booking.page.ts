...
@Component({
  selector: 'app-handyzone-booking',
  templateUrl: './handyzone-booking.page.html',
  styleUrls: ['./handyzone-booking.page.scss'],
})
export class HandyzoneBookingPage implements OnInit {
  faqExpand1: boolean;
  faqExpand2: boolean;
  faqExpand3: boolean;
  faqExpand4: boolean;
  ...
  faqExpand13: boolean;
  faqExpand14: boolean;
  constructor(private modalController: ModalController, private route: Router, private navCtrl: NavController) { }
  ...
  booking_confirmation() {
    this.modalController.dismiss();
    this.navCtrl.navigateRoot(['./handyzone-tabs/handyzoneMyBookings']);
  }
}
